...
| `REFRESH_TOKEN` | `text` | NOT NULL, UNIQUE | Refresh token đã hash |
...
| `MA_NGUOI_DUNG` | `uuid` | NOT NULL, FK -> `ho_so_sinh_vien.MA_NGUOI_DUNG` | Sinh viên sở hữu học kỳ |
...
| `MA_BAN_GHI` | `varchar(100)` | NULL | Mã bản ghi bị tác động |
