...
| `idx_lich_hoc_thu_tiet` | `lich_hoc` | (`THU`, `TIET_BAT_DAU`, `SO_TIET`) | Hỗ trợ kiểm tra trùng thời khóa biểu <span style="color:red;">(XEM LẠI CÓ THỂ TỐI ƯU BẰNG KIỂU DỮ LIỆU RANGE KẾT HỢP VỚI INDEX GiST VÀ RÀNG BUỘC EXCLUDE)</span> |
